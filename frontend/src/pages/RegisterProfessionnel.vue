<template>
  <AuthForm
    :title="`Inscription Professionnel - Étape ${currentStep}/4`"
  ...
  >
    <template #default="{ form, errors }">
      ...
      <div v-if="currentStep === 3" class="space-y-6">
        ...
        <div class="space-y-3">
          <p class="text-sm font-medium text-gray-700">Réseaux sociaux (optionnel)</p>
      ...
      <div v-if="currentStep === 4" class="space-y-6">
        ...
        <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-purple-800">Abonnement</h3>
