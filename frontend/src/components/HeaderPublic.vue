      ...
      <nav class="hidden md:flex space-x-12 items-center">
        ...
        <template v-else>
          ...
          <template v-if="authStore.isPro">
            <router-link to="/pro/favoris" class="text-sm font-bold uppercase tracking-widest text-text hover:text-accent transition-colors duration-300">
              Mes favoris
            </router-link>
            <router-link to="/pro/encheres" class="text-sm font-bold uppercase tracking-widest text-text hover:text-accent transition-colors duration-300">
               Enchères
            </router-link>
            <router-link to="/pro/historique" class="text-sm font-bold uppercase tracking-widest text-text hover:text-accent transition-colors duration-300">
               Historique
            </router-link>
          </template>
