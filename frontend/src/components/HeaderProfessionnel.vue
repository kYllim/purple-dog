  ...
  <header class="fixed w-full top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm">
    <div class="max-w-[1920px] mx-auto px-6 h-20 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-12 items-center relative">
        <router-link to="/professionnel/dashboard" class="text-sm font-bold uppercase tracking-widest text-text hover:text-accent transition-colors duration-300">
          Dashboard
        </router-link>
        ...
        <router-link to="/professionnel/favoris" class="text-sm font-bold uppercase tracking-widest text-text hover:text-accent transition-colors duration-300">
          Mes favoris
        </router-link>
        <router-link to="/professionnel/historique" class="text-sm font-bold uppercase tracking-widest text-text hover:text-accent transition-colors duration-300">
          Mon historique
        </router-link>
